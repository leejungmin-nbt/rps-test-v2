// =====================================================================
// 데이터 모델 타입 정의 (Firestore 컬렉션 contract) — 클라이언트(web) 측
// =====================================================================
...
// 모노레포 / 타입 동기화 안내
// ─────────────────────────────────────────────────────────────────────
// 본 파일은 web (클라이언트) 측 타입 정의이고, functions (서버) 측은
// 같은 인터페이스를 별도로 정의한다. 두 프로젝트가 사용하는 Timestamp
// 가 서로 다른 패키지(firebase/firestore vs firebase-admin/firestore)
// 라서 단일 파일 공유가 어렵기 때문이다.
//
// 인터페이스 이름·필드·enum 값은 양쪽이 정확히 일치해야 한다.
// 변경 시 반드시 양쪽 모두 동시에 갱신할 것.
//
// 향후 본격 모노레포 도구(pnpm workspaces / turborepo) 도입 시
// shared 패키지로 이전하면 자동 동기화 가능.
// ─────────────────────────────────────────────────────────────────────
//
// 컬렉션 트리:
